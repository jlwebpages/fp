...
function build_regular_season_form()
{
   ...
   d.writeln('         for (var j = 1; j <= '+max_number_of_rs_games+'-'+number_of_rs_games+'; j++)');
   d.writeln('         {');
   d.writeln('            // Must put one blank before "\\r" so that the blank lines get generated properly.');
   d.writeln('');
   d.writeln('            mail_msg += " \\r";');
   d.writeln('         }');
   d.writeln('      }');
   d.writeln('');
   d.writeln('      mail_msg +=   picks[i] + " ";');
   d.writeln('      mail_msg += weights[i] + "\\r";');
   d.writeln('   }');
   d.writeln('');
   ...
   d.writeln('   if (picks_from_odds_button_pressed == true)');
   d.writeln('   {');
   d.writeln('      mail_msg += "\\r\\rPicks from odds.";');
   d.writeln('   }');
   d.writeln('   else if (home_team_picks_button_pressed == true)');
   d.writeln('   {');
   d.writeln('      mail_msg += "\\r\\r"+home_team_picks_generated;');
   d.writeln('   }');
   d.writeln('   else if (random_picks_button_pressed == true)');
   d.writeln('   {');
   d.writeln('      mail_msg += "\\r\\r"+random_picks_generated;');
   d.writeln('   }');
   d.writeln('');
...
function build_post_season_form()
{
   ...
   d.writeln('   for (var i = 0; i < '+number_of_ps_games+'; i++)');
   d.writeln('   {');
   d.writeln('      mail_msg += picks[i] + " by " + spread_values[i] + "\\r";');
   d.writeln('   }');
   d.writeln('');
