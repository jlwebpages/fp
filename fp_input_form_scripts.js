...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('      bring_input_form_into_view();');
   d.writeln('');
   d.writeln('      return false;');
   d.writeln('   }');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('');
   d.writeln('function bring_input_form_into_view()');
   d.writeln('{');
   ...
   d.writeln('   wd.writeln("      {");');
   d.writeln('   wd.writeln("         top.fp_main.bring_input_form_into_view();");');
   d.writeln('   wd.writeln("      }");');
   d.writeln('   wd.writeln("   }");');
   ...
   d.writeln('   get_nfl_odds(document,true);');
   d.writeln('');
   d.writeln('   // Un-hide the "Picks From Odds" button and the "Display Point Spreads from NFL Odds" checkbox if needed.');
   d.writeln('');
   d.writeln('   bring_input_form_into_view();');
   d.writeln('');
