...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('               if (isNaN(home_team_picks_array[i][noa_total_points_index]) == false)');
   d.writeln('               {');
   ...
   d.writeln('');
   d.writeln('                  if ( (isNaN(total_points) == false) && (total_points % 1 != 0) )');
   d.writeln('                  {');
   ...
   d.writeln('               total_points = 0;');
   d.writeln('');
   d.writeln('               if (isNaN(nfl_odds_array[i][noa_total_points_index]) == false)');
   d.writeln('               {');
