...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('                           // If there\'s a way to determine if the odds are even, set the favored team to the home team and set the point_spread to -1.');
   d.writeln('');
   ...
   d.writeln('            }');
   d.writeln('            else if ( (game.odds[0].odd.pointSpread.currentHomeHandicap == "PK") || (game.odds[0].odd.pointSpread.currentAwayHandicap == "PK") )');
   d.writeln('            {');
   d.writeln('                 point_spread = 0;');
   d.writeln('                 favored_team = home_team;');
   d.writeln('            }');
