...
function build_regular_season_form()
{
   ...
   d.writeln('   var nfl_odds_url        = ["blabla","www.sportsline.com/nfl/odds"];'); //JLJL
   //d.writeln('   var nfl_odds_url        = ["www.espn.com/nfl/lines","www.sportsline.com/nfl/odds"];'); //JLJL
   ...
   d.writeln('      // Get NFL Odds information from each game in the game_list.');
   d.writeln('');
   d.writeln('      for (var j = 0; j < game_list.length-1; j++)'); //JLJL
   d.writeln('      {');
   d.writeln('         // Reset NFL Odds variables.');
   d.writeln('');
   d.writeln('         favored_team = "";');
   ...
   d.writeln('');
   d.writeln('         // Get the home and visiting team names and records (visiting is assumed to be in row[0] and home is assumed to be in row[1]).');
   d.writeln('//JL MOVE TEAM RECORDS INSIDE K LOOP BELOW.');
