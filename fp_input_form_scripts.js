...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('                  top.display_frame(restore_frame);');
   d.writeln('               }');
   d.writeln('               else');
   d.writeln('               {');
   d.writeln('                  // Try again.');
   ...
   for (var i = 1; i <= number_of_games; i++)
   {
      ...
      if (i == number_of_games)
      {
         ...
         d.writeln('<td class="gr1_border" nowrap><font style="font-size: 12pt" id="'+visiting_teams[i-1]+'">' + visiting_teams[i-1] + 'XXXXXXXXXX</font></td>');
         d.writeln('<td class="gr1_border"><font style="font-size: 12pt">at</font></td>');
         d.writeln('<td class="br2_border" nowrap><font style="font-size: 12pt" id="'+home_teams[i-1]+'">' + home_teams[i-1] + 'XXXXXXXXXX</font></td>');
