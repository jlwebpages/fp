...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('   update_input_form(document,false);');
   d.writeln('');
   d.writeln('   return true;');
   d.writeln('}');
   d.writeln('');
   d.writeln('');
   d.writeln('function update_input_form(document,display_frame)');
   d.writeln('{');
   ...
   d.writeln('');
   d.writeln('   if (display_frame == true) top.display_frame("fp_main",0);');
   d.writeln('');
   d.writeln('   return;');
   d.writeln('}');
   d.writeln('');
   ...
   d.writeln('<input type=checkbox style="vertical-align: middle" id="display_odds_checkbox" onClick="update_input_form(document,true);">');
   ...
   d.writeln('&nbsp&nbsp;');
   d.writeln('<input type=checkbox style="vertical-align: middle" id="display_team_records_checkbox" onClick="update_input_form(document,true);">');
