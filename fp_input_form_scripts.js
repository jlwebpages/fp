...
function build_regular_season_form()
{
   ...
   d.writeln('   confirmation_message += "\\n<tr><td colspan=5><hr style=\\"border: 1px solid black\\"></td></tr>";');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"text-align: left; padding-top: 5px; padding-bottom: 10px\\" colspan=5><b>Name:&nbsp&nbsp" + player_name + "</b></td></tr>";');
   d.writeln('   confirmation_message += format_picks_for_dialog(document,true,0);');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"text-align: left; padding-top: 10px; padding-bottom: 5px\\" colspan=5>Monday Night Total Points:&nbsp&nbsp" + mn_points + "</td></tr>";');
   d.writeln('   confirmation_message += "\\n<tr><td colspan=5><hr style=\\"border: 1px solid black\\"></td></tr>";');
   d.writeln('   confirmation_message += "\\n</table>";');
   d.writeln('   confirmation_message += "\\n</center>\\n";');
   d.writeln('');
   ...
   d.writeln('   var random_picks_error_message = "";');
   ...
   d.writeln('   wd.writeln("");');
   d.writeln('');
   d.writeln('   if ( (message_mode != "confirm_picks") && (message_mode != "copy") )');
   d.writeln('   {');
   ...
   d.writeln('      {');
   d.writeln('         random_picks_error_message = "You can\'t use the same weight more than once.\\n\\n\\n";');
   d.writeln('      }');
   d.writeln('   }');
   d.writeln('');
   ...
   d.writeln('   wd.writeln("");');
   d.writeln('   wd.writeln("<td>"+html_tag_start+random_picks_error_message+picks_message+html_tag_end+"</td>");');
   d.writeln('   wd.writeln("");');
   d.writeln('   wd.writeln("</tr>");');
   d.writeln('   wd.writeln("");');
   d.writeln('   wd.writeln("<tr>");');
   d.writeln('   wd.writeln("");');
   d.writeln('   wd.writeln("<td style=\\"text-align: center; padding: 10px 0px 5px 0px\\">");');
   d.writeln('');
   ...
   d.writeln('   wd.writeln("");');
   d.writeln('');
   d.writeln('   if ((button_2 == "Submit via E-Mail") && (upset_note != ""))');
   d.writeln('   {');
   d.writeln('      wd.writeln("<tr>");');
   d.writeln('      wd.writeln("");');
   ...
   d.writeln('               formatted_picks += "<td style=\\"text-align: left; padding: 0px 30px 0px 0px\\">" + winning_team + "</td>";');
   d.writeln('               formatted_picks += "<td style=\\"padding: 0px\\">over</td>";');
   d.writeln('               formatted_picks += "<td style=\\"text-align: left; padding: 0px 30px 0px 30px\\">" + losing_team + "</td>";');
   d.writeln('               formatted_picks += "<td style=\\"padding: 0px 5px 0px 0px\\">" + pick + "</td>";');
   ...
   d.writeln('            else');
   d.writeln('            {');
   d.writeln('               // Build the line in plain text format.');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('               formatted_picks += game_prefix + pad_text_string(winning_team);');
   d.writeln('');
   d.writeln('               if (picks[j] == 0)');
   d.writeln('               {');
   d.writeln('                  formatted_picks += "at     ";');
   d.writeln('               }');
   d.writeln('               else');
   d.writeln('               {');
   d.writeln('                  formatted_picks += "over   ";');
   d.writeln('               }');
   d.writeln('');
   d.writeln('               formatted_picks += pad_text_string(losing_team) + pick + " " + weight +  "\\n";');
   d.writeln('            }');
   d.writeln('         }');
   d.writeln('      }');
   d.writeln('   }');
   ...
   d.writeln('         weight = "  " + "  ";');
   d.writeln('');
   d.writeln('         formatted_picks += game_prefix + winning_team + "over   " + losing_team + pick + " " + weight + "\\n";');
   d.writeln('      }');
   d.writeln('   }');
   d.writeln('');
   ...
   d.writeln('         weight = "  " + "  ";');
   d.writeln('');
   d.writeln('         formatted_picks += game_prefix + pad_text_string(visiting_teams[j]) + "at     " + pad_text_string(home_teams[j]) + pick + " " + weight + "\\n";');
   d.writeln('      }');
   d.writeln('   }');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('            duplicate_weight_games = duplicate_weight_games + format_picks_for_dialog(document,false,(j+1));');
   d.writeln('');
   ...
   d.writeln('      error_message += "Preview of picks so far:\\n\\n" + format_picks_for_dialog(document,false,0) + "\\n\\n";');
...
function build_post_season_form()
{
   ...
   d.writeln('         {');
   d.writeln('            html_tag_start = "";');
   d.writeln('            html_tag_end   = "";');
   d.writeln('');
   d.writeln('            if (winning_team == nfl_odds_array[j][noa_team_index])');
   d.writeln('            {');
   d.writeln('               if (display_spreads_from_odds == true)');
   d.writeln('               {');
   d.writeln('                  // Add the NFL Odds point spread to the winning team.');
   d.writeln('');
   d.writeln('                  winning_team = winning_team + " " + nfl_odds_array[j][noa_spread_index];');
   d.writeln('               }');
   d.writeln('');
   d.writeln('               break;');
   d.writeln('            }');
   d.writeln('            else if (losing_team == nfl_odds_array[j][noa_team_index])');
   d.writeln('            {');
   d.writeln('               if (display_spreads_from_odds == true)');
   d.writeln('               {');
   d.writeln('                  // Add the NFL Odds point spread to the losing team.');
   d.writeln('');
   d.writeln('                  losing_team = losing_team + " " + nfl_odds_array[j][noa_spread_index];');
   d.writeln('               }');
   d.writeln('');
   d.writeln('               // The losing team is favored so change the text color for this game to indicate this game is an upset pick.');
   d.writeln('');
   d.writeln('               html_tag_start = "<font class=upset_pick_color>";');
   d.writeln('               html_tag_end   = "</font>";');
   d.writeln('');
   d.writeln('               break;');
   d.writeln('            }');
   d.writeln('         }');
   ...
   d.writeln('   if (top.mobile == true)');
   d.writeln('   {');
   d.writeln('      font_style = " style=\\"font-size: 12px\\"";');
   d.writeln('   }');
   d.writeln('');
   d.writeln('   background_color = green_color;');
   d.writeln('');
   ...
   d.writeln('   if ((display_spreads_from_odds == true) && (nfl_odds_array[0].length > 0))');
   d.writeln('   {');
   d.writeln('      required_length = required_length + 6;');
   d.writeln('   }');
   d.writeln('');
   d.writeln('   while (output_string.length < required_length)');
   d.writeln('   {');
   ...
   d.writeln('<tr align=center>');
   d.writeln('<td class="no_border" colspan=1><font>&nbsp;</font></td>');//JLJL
   ...
   d.writeln('<tr><td class="no_border" style="font-size: 2pt">&nbsp;</td></tr>');//JLJL
   d.writeln('');
   ...
   d.writeln('<tr><td class="no_border" style="font-size: 1pt">&nbsp;</td></tr>');//JLJL
   d.writeln('');
