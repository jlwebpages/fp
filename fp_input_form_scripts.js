...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('   if (navigator.userAgent.toLowerCase().indexOf("mobile") != -1)');
   d.writeln('   {');
   d.writeln('      if (platform.indexOf("iphone") != -1 || platform.indexOf("ipad") != -1 || platform.indexOf("macintel") != -1)');
   d.writeln('      {');
   d.writeln('         if (navigator.userAgent.replace(/_/g,".").indexOf("14.") != -1) ios_bug = true;');
   d.writeln('      }');
   d.writeln('   }');
   d.writeln('');
   d.writeln('   if (name.indexOf("DC") != -1) ios_bug = true;');
   d.writeln('');
