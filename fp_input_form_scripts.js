...
function build_regular_season_form()
{
   ...
   d.writeln('var nfl_odds_array                 = new Array('+number_of_games+');');
   ...
   d.writeln('   confirmation_message += "\\n<table>";');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"text-align: center\\" colspan=5><b>Week " + '+week+' + " Picks</b></td></tr>";');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"text-align: center\\" colspan=5><hr style=\\"border: 1px solid black\\"></td></tr>";');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"padding-top: 5px; padding-bottom: 10px\\" colspan=5><b>Name:&nbsp&nbsp" + build_player_name(-1) + "</b></td></tr>";');
   d.writeln('   confirmation_message += format_picks_for_dialog(document,true,0);');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"padding-top: 10px; padding-bottom: 5px\\" colspan=5>Monday Night Total Points:&nbsp&nbsp" + document.fp_inputs.mn_points.value + "</td></tr>";');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"text-align: center\\" colspan=5><hr style=\\"border: 1px solid black\\"></td></tr>";');
   d.writeln('   confirmation_message += "\\n</table>";');
   d.writeln('   confirmation_message += "\\n</center>\\n";');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('      picks_message  = "\\n<div style=\\"font-size: 0%\\">";  // JL - workaround so line height is not increased due to <!DOCTYPE html>');
   d.writeln('      picks_message += "\\n<span style=\\"font-family: Calibri; font-size: 11pt\\">";');
   d.writeln('      picks_message += "\\n<b>Manually create an e-mail message and send it to:</b><br><br>";');
   d.writeln('      picks_message += "\\nfp@socal.rr.com<br><br>";');
   d.writeln('      picks_message += "\\n<b>Copy the following into the message subject line:</b><br><br>";');
   d.writeln('      picks_message += "\\n" + build_player_name(-1) + " - Week "+'+week+'+" Picks<br><br>";');
   d.writeln('      picks_message += "\\n<b>Copy all of the following exactly as is into the message body:</b><br><br>";');
   d.writeln('');
   d.writeln('      for (var i = 0; i < '+number_of_games+'; i++)');
   d.writeln('      {');
   ...
   d.writeln('               formatted_picks += "<td style=\\"text-align: center; padding: 0px 5px 0px 0px\\">" + pick + "</td>";');
   d.writeln('               formatted_picks += "<td style=\\"text-align: right; padding: 0px\\">" + weight + "</td>";');
   ...
   d.writeln('               formatted_picks += "<td style=\\"padding: 0px 30px 0px 30px\\">" + winning_team + "</td>";');
   d.writeln('');
   d.writeln('               if (picks[j] == 0)');
   d.writeln('               {');
   d.writeln('                  formatted_picks += "<td style=\\"padding: 0px\\">at</td>";');
   d.writeln('               }');
   d.writeln('               else');
   d.writeln('               {');
   d.writeln('                  formatted_picks += "<td style=\\"padding: 0px\\">over</td>";');
   ...
   d.writeln('         formatted_picks += "<td style=\\"padding: 0px\\">Game&nbsp</td>";');
   d.writeln('         formatted_picks += "<td style=\\"text-align: right; padding: 0px\\">" + (j+1) + ":</td>";');
   d.writeln('         formatted_picks += "<td style=\\"padding: 0px 30px 0px 30px\\">" + visiting_teams[j] + "</td>";');
   d.writeln('         formatted_picks += "<td style=\\"padding: 0px\\">at</td>";');
   d.writeln('         formatted_picks += "<td style=\\"padding: 0px 30px 0px 30px\\">" + home_teams[j] + "</td>";');
   d.writeln('         formatted_picks += "<td style=\\"text-align: center; padding: 0px 5px 0px 0px\\">" + pick + "</td>";');
   d.writeln('         formatted_picks += "<td style=\\"text-align: right; padding: 0px\\">" + weight + "</td>";');
   d.writeln('         formatted_picks += "</tr>";');
   d.writeln('      }');
   ...
   d.writeln('');
   d.writeln('   if (get_nfl_odds(document,false) == false)');
   d.writeln('   {');
   d.writeln('      return false;');
   d.writeln('   }');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('            hide_display_spreads_checkbox(document);');
   d.writeln('');
   d.writeln('            return false;');
   d.writeln('         }');
   d.writeln('      }');
   ...
   d.writeln('');
   d.writeln('      if (nfl_odds_array[i].indexOf("tdwidth") != -1)');
   d.writeln('      {');
   d.writeln('         nfl_odds = nfl_odds.replace(/<tr>/i,"");');
   d.writeln('         nfl_odds = nfl_odds.replace(/<\\/tr>/i,"");');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('      // Clean up the information in nfl_odds_array.');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('      index1 = nfl_odds_array[i].indexOf("<font");');
   d.writeln('      index2 = nfl_odds_array[i].indexOf("font>");');
   d.writeln('');
   d.writeln('      if ( (index1 != -1) && (index2 > index1) )');
   d.writeln('      {');
   d.writeln('         temp_string = nfl_odds_array[i].substring(index1,index2+5);');
   d.writeln('');
   d.writeln('         nfl_odds_array[i] = nfl_odds_array[i].replace(temp_string,"");');
   d.writeln('      }');
   d.writeln('');
   ...
   d.writeln('         {');
   d.writeln('            nfl_odds_array[i] = nfl_odds_array[i] + "H" + suffix;');
   d.writeln('');
   d.writeln('            exit_loop = true;');
   d.writeln('         }');
   d.writeln('         else if (temp_string[0] == visiting_teams[j])');
   d.writeln('         {');
   d.writeln('            nfl_odds_array[i] = nfl_odds_array[i] + "V" + suffix;');
   d.writeln('');
   d.writeln('            exit_loop = true;');
   d.writeln('         }');
   d.writeln('');
   ...
   d.writeln('   // Index 1 = noa_spread_index.  Index 3 = noa_sort_key_index.');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('');
   d.writeln('function hide_display_spreads_checkbox(document)');
   d.writeln('{');
   d.writeln('   document.getElementById("display_spreads_div").style.display = "none";');
   d.writeln('');
   d.writeln('   return;');
   d.writeln('}');
   d.writeln('');
   ...
   d.writeln('                  error_message += "\\n<table>";');
   d.writeln('                  error_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>Pick a winner (V or H) for:<br><br></td></tr>";');
   d.writeln('                  error_message += "\\n<tr style=\\"line-height: 100%\\"><td></td><td colspan=6>\\""+visiting_teams[j]+" at "+home_teams[j]+"\\" (Game "+(j+1)+")<br><br></td></tr>";');
   d.writeln('                  error_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>Preview of picks so far:<br><br></td></tr>";');
   ...
   d.writeln('            error_message += "\\n<center>";');
   d.writeln('            error_message += "\\n<table>";');
   d.writeln('            error_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>Assign a weight to:<br><br></td></tr>";');
   d.writeln('            error_message += "\\n<tr style=\\"line-height: 100%\\"><td></td><td colspan=6>\\""+winning_team+" over "+losing_team+"\\" (Game "+(j+1)+")<br><br></td></tr>";');
   d.writeln('            error_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>These weights have not been used:<br><br></td></tr>";');
   d.writeln('            error_message += "\\n<tr style=\\"line-height: 100%\\"><td></td><td colspan=6>"+available_weights+"<br><br></td></tr>";');
   d.writeln('            error_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>Preview of picks so far:<br><br></td></tr>";');
   d.writeln('            error_message += format_picks_for_dialog(document,false,0);');
   d.writeln('            error_message += "\\n</table>";');
   d.writeln('            error_message += "\\n</center>\\n";');
   ...
   d.writeln('         {');
   d.writeln('            duplicate_weight_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>Weight \\"" + i + "\\" has been used " + specific_duplicate_weight_count + " times:<br><br></td></tr>";');
   d.writeln('         }');
   d.writeln('         else');
   d.writeln('         {');
   d.writeln('            duplicate_weight_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7><br>Weight \\"" + i + "\\" has been used " + specific_duplicate_weight_count + " times:<br><br></td></tr>";');
   d.writeln('         }');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('         duplicate_weight_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7><br><br>Each weight can only be used once.</td></tr>";');
   d.writeln('         duplicate_weight_message += "\\n</table>";');
   d.writeln('         duplicate_weight_message += "\\n</center>\\n";');
   d.writeln('');
   ...
   d.writeln('         // Alert the user of all duplicate weights.');
   d.writeln('');
   d.writeln('         duplicate_weight_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7><br><br>Each weight can only be used once.<br><br></td></tr>";');
   d.writeln('         duplicate_weight_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>These weights have not been used:<br><br></td></tr>";');
   d.writeln('         duplicate_weight_message += "\\n<tr style=\\"line-height: 100%\\"><td></td><td colspan=6>" + available_weights + "</td></tr>";');
   d.writeln('         duplicate_weight_message += "\\n</table>";');
   d.writeln('         duplicate_weight_message += "\\n</center>\\n";');
   d.writeln('');
   d.writeln('         display_picks_message(duplicate_weight_message,"duplicate_weights");');
   ...
   d.writeln('         else');
   d.writeln('         {');
   d.writeln('            weight_shift_message = "Weights " + duplicate_weight + " to " + (weight_not_used-1) + " will be incremented by one.";');
   d.writeln('         }');
   d.writeln('      }');
   d.writeln('');
   d.writeln('      if (weight_not_used < duplicate_weight)');
   ...
   d.writeln('         else');
   d.writeln('         {');
   d.writeln('            weight_shift_message = "Weights " + (weight_not_used+1) + " to " + duplicate_weight + " will be decremented by one.";');
   d.writeln('         }');
   d.writeln('      }');
   d.writeln('');
   ...
   d.writeln('         error_message += "\\n<center>";');
   d.writeln('         error_message += "\\n<table>";');
   d.writeln('         error_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>Weight \\"" + duplicate_weight + "\\" has been used twice.<br><br></td></tr>";');
   d.writeln('         error_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>Weight \\"" + weight_not_used  + "\\" has not been used.<br><br></td></tr>";');
   d.writeln('         error_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>Preview of picks so far:<br><br></td></tr>";');
   d.writeln('         error_message += format_picks_for_dialog(document,false,0);');
   d.writeln('         error_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7><br><br>Fix 1:&nbsp&nbspKeep \\"" + duplicate_weight + "\\" assigned to \\"" + winning_team + " over " + losing_team + "\\" (Game " + (duplicate_weight_game_1+1) + ").<br></td></tr>";');
   d.writeln('         error_message += "\\n<tr style=\\"line-height: 100%\\"><td colspan=7>Fix 2:&nbsp&nbspKeep \\"" + duplicate_weight + "\\" assigned to \\"" + winning_team2 + " over " + losing_team2 + "\\" (Game " + (duplicate_weight_game_2+1) + ").<br><br></td></tr>";');
   d.writeln('         error_message += "\\n<tr style=\\"line-height: 100%\\"><td></td><td colspan=6>" + weight_shift_message + "</td></tr>";');
   d.writeln('         error_message += "\\n</table>";');
   d.writeln('         error_message += "\\n</center>\\n";');
   d.writeln('');
   ...
   for (var i = 1; i <= number_of_games; i++)
   {
      ...
      if (i == number_of_games)
      {
         ...
         d.writeln('<td class="gr1_border"><font style="font-size: 12pt" id="'+visiting_teams[i-1]+'">' + visiting_teams[i-1] + '</font></td>');
         d.writeln('<td class="gr1_border"><font style="font-size: 12pt">at</font></td>');
         d.writeln('<td class="br2_border"><font style="font-size: 12pt" id="'+home_teams[i-1]+'">' + home_teams[i-1] + '</font></td>');
      ...
      else
      {
         ...
         d.writeln('<td><font style="font-size: 12pt" id="'+visiting_teams[i-1]+'">' + visiting_teams[i-1] + '</font></td>');
         d.writeln('<td><font style="font-size: 12pt">at</font></td>');
         d.writeln('<td class="br2_gb1_border"><font style="font-size: 12pt" id="'+home_teams[i-1]+'">' + home_teams[i-1] + '</font></td>');
   ...
   d.writeln('if (nfl_odds_array[0].length > 0)');
   d.writeln('{');
   d.writeln('   // Un-hide the "Display Point Spreads from NFL Odds" checkbox.');
   d.writeln('');
   d.writeln('   document.getElementById("display_spreads_div").style.display = "";');
   d.writeln('}');
   d.writeln('');
   d.writeln('document.fp_inputs.pick1.focus();');
   d.writeln('');
...
function build_post_season_form()
{
   ...
   d.writeln('   confirmation_message  = "\\n<center>";');
   d.writeln('   confirmation_message += "\\n<table>";');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"text-align: center\\" colspan=5><b>Post Season Week " + '+week+' + " Picks</b></td></tr>";');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"text-align: center\\" colspan=5><hr style=\\"border: 1px solid black\\"></td></tr>";');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"padding-top: 5px; padding-bottom: 10px\\" colspan=5><b>Name:&nbsp&nbsp" + build_player_name(-1) + "</b></td></tr>";');
   d.writeln('');
   ...
   d.writeln('      picks_message += "\\nfp@socal.rr.com<br><br>";');
   d.writeln('      picks_message += "\\n<b>Copy the following into the message subject line:</b><br><br>";');
   d.writeln('      picks_message += "\\n" + build_player_name(-1) + " - Post Season Week "+'+week+'+" Picks<br><br>";');
   d.writeln('      picks_message += "\\n<b>Copy all of the following exactly as is into the message body:</b><br><br>";');
   d.writeln('');
   d.writeln('      for (var i = 0; i < '+number_of_games+'; i++)');
   d.writeln('      {');
   ...
   d.writeln('<tr align=center>');
   d.writeln('<td class="no_border" colspan=6 align=right><font style="font-size: 13pt">Game '+number_of_games+' Total Points:</font></td>');
