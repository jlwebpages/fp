...
function build_regular_season_form()
{
   ...
   d.writeln('   var saved_fp_frameset_columns = "";');
   ...
   d.writeln('');
   d.writeln('   saved_fp_frameset_columns = top.document.getElementById("fp_frameset").cols;');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('            // Remove loading indicator by restoring fp_frameset columns.');
   d.writeln('');
   d.writeln('            top.document.getElementById("fp_frameset").cols = saved_fp_frameset_columns;');
   d.writeln('');
   d.writeln('            return false;');
   d.writeln('         }');
   d.writeln('      }');
   ...
   d.writeln('<script language="JavaScript" type="text/javascript">');
   d.writeln('');
   d.writeln('// If NFL Odds data exists, un-hide the "Picks From Odds" button and the "Display Point Spreads from NFL Odds" checkbox.');
   d.writeln('');
   d.writeln('if (nfl_odds_array[0].length > 0)');
   d.writeln('{');
   d.writeln('   document.getElementById("picks_from_odds_span").style.display = "";');
   d.writeln('   document.getElementById("display_spreads_span").style.display = "";');
   d.writeln('}');
   d.writeln('');
   d.writeln('document.fp_inputs.pick1.focus();');
   d.writeln('');
