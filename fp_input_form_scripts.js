...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('   // Extract the Monday Night Total Points data from the nfl_odds string.');
   d.writeln('');
   d.writeln('   index1 = nfl_odds.indexOf((visiting_teams['+number_of_rs_games+'-1]+"-@-"+home_teams['+number_of_rs_games+'-1]).toLowerCase());');
   d.writeln('');
   d.writeln('   if (index1 != -1) index2 = nfl_odds.substring(index1,nfl_odds.length).indexOf("</a>");');
   d.writeln('');
   d.writeln('   if (index2 != -1) temp_string = nfl_odds.substring(index1,index1+index2);');
   d.writeln('');
   d.writeln('   if (temp_string != "")');
   d.writeln('   {');
   d.writeln('      index = temp_string.indexOf("<br>");');
   d.writeln('');
   d.writeln('      if (index != -1)');
   d.writeln('      {');
   d.writeln('         for (var i = index + 4; i < temp_string.length; i++)');
   d.writeln('         {');
   d.writeln('            if (isNaN(temp_string.substring(i,i+1)) == false)');
   d.writeln('            {');
   d.writeln('               mn_points = mn_points + temp_string.substring(i,i+1);');
   d.writeln('            }');
   d.writeln('            else');
   d.writeln('            {');
   d.writeln('               break;');
   ...
   d.writeln('');
   d.writeln('   index = nfl_odds.indexOf(("NFL Week '+week+'").toLowerCase());');
   d.writeln('');
   d.writeln('   if (index != -1) nfl_odds = nfl_odds.substring(index,nfl_odds.length);');
   d.writeln('');
   d.writeln('   // Strip off as much of the ending of the nfl_odds html string as possible.');
   d.writeln('');
   d.writeln('   index = nfl_odds.indexOf(("<h2>").toLowerCase());');
   d.writeln('');
   ...
   d.writeln('      }');
   d.writeln('');
   d.writeln('      // Put the NFL Odds point spread in the second element in nfl_odds_array.');
   d.writeln('');
   ...
   d.writeln('      }');
   d.writeln('');
   d.writeln('      // Assign zero for total points in the third element in nfl_odds_array except for the last game of the week which will be assigned to mn_points.');
   d.writeln('');
   d.writeln('      if (i == '+number_of_rs_games+' - 1)');
   d.writeln('      {');
   d.writeln('         nfl_odds_array[i] = nfl_odds_array[i] + mn_points + " ";  // The blank (" ") is used as a delimiter.');
   d.writeln('      }');
   d.writeln('      else');
   d.writeln('      {');
   d.writeln('         nfl_odds_array[i] = nfl_odds_array[i] + 0 + " ";  // The blank (" ") is used as a delimiter.');
