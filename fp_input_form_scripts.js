...
function build_regular_season_form()
{
   ...
   d.writeln('   {');
   d.writeln('      // Get game information from the game list.');
   d.writeln('');
   ...
   d.writeln('         {');
   d.writeln('            if (game.displayGroups[0].markets[0].outcomes[0].price.handicap < 0)');
   d.writeln('            {');
   d.writeln('               favored_team = game.displayGroups[0].markets[0].outcomes[0].description;');
   d.writeln('               point_spread = game.displayGroups[0].markets[0].outcomes[0].price.handicap;');
   d.writeln('               odds_found   = true;');
   d.writeln('            }');
   d.writeln('            else if (game.displayGroups[0].markets[0].outcomes[1].price.handicap < 0)');
   d.writeln('            {');
   d.writeln('               favored_team = game.displayGroups[0].markets[0].outcomes[1].description;');
