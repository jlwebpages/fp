...
function build_regular_season_form()
{
   ...
   d.writeln('   if (counter  > '+number_of_games+' - 1) random_picks_generated = "No random picks.";');
   d.writeln('');
   ...
   d.writeln('   if ( (counter  > 0)                   && (counter < '+number_of_games+') )                random_picks_generated = "Partial random picks.";');
   d.writeln('   if ( (counter == '+number_of_games+') && (random_picks_generated != "No random picks.") ) random_picks_generated = "Partial random picks.";');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('      // Look for and remove "<fontsize=-1>"');
   d.writeln('');
   d.writeln('      index = nfl_odds_array[i].indexOf("<font");');
   d.writeln('');
   d.writeln('      if (index != -1)');
   d.writeln('      {');
   d.writeln('         temp_string = nfl_odds_array[i].substring(index,index+13);');
   d.writeln('');
   ...
   d.writeln('      if (index != -1)');
   d.writeln('      {');
   d.writeln('         temp_string = nfl_odds_array[i].substring(index,index+14);');
   d.writeln('');
   d.writeln('         nfl_odds_array[i] = nfl_odds_array[i].replace(temp_string,"");');
   d.writeln('      }');
   d.writeln('');
   d.writeln('      // Look for and remove any information contained in parentheses and also remove the parentheses too.');
   d.writeln('');
   d.writeln('      index1 = nfl_odds_array[i].indexOf("(");');
   d.writeln('      index2 = nfl_odds_array[i].indexOf(")");');
   d.writeln('');
   d.writeln('      if ( (index1 != -1) && (index2 > index1) )');
   d.writeln('      {');
   d.writeln('         temp_string = nfl_odds_array[i].substring(index1,index2+1);');
   d.writeln('');
   d.writeln('         nfl_odds_array[i] = nfl_odds_array[i].replace(temp_string,"");');
   d.writeln('      }');
   d.writeln('');
...
function build_post_season_form()
{
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   if (counter == (('+number_of_games+'*2) + 1))');
   d.writeln('   {');
   d.writeln('      alert("Random picks weren\'t generated because no picks were left blank.");');
   d.writeln('');
   d.writeln('      return false;');
