...
function build_post_season_form()
{
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // If an nfl_odds_array element is blank because one of this week\'s games wasn\'t found in any');
   d.writeln('   // of the game_lists or the point_spread for one of the game\'s is zero, set odds_found to false.');
   d.writeln('');
   d.writeln('   for (var j = 0; j < '+number_of_ps_games+'; j++)');
   d.writeln('   {');
   d.writeln('      if (nfl_odds_array[j] == "")');
