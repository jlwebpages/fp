...
function build_regular_season_form()
{
   ...
   d.writeln('               }');
   d.writeln('');
   d.writeln('               if (nfl_odds_week_error == false)');
   d.writeln('               {');
   ...
   d.writeln('            }');
   d.writeln('');
   d.writeln('            if (nfl_odds_valid == false && odds_source == espn)');
   d.writeln('            {');
   ...
   d.writeln('');
   d.writeln('         // Get the home and visiting team names (visiting is assumed to be in row[0] and home is assumed to be in row[1]).');
   d.writeln('');
   ...
   d.writeln('            {');
   d.writeln('               // Get the home and visiting team records (visiting is assumed to be in row[0] and home is assumed to be in row[1]).');
   d.writeln('');
   ...
   d.writeln('            nfl_odds_array[k][noa_total_points_index] = total_points;');
   d.writeln('');
   d.writeln('            /*JLJL*/ alert(nfl_odds_array[k]);');
   d.writeln('');
   d.writeln('            break;');
   d.writeln('         }');
   d.writeln('      }');
   ...
   d.writeln('         }');
   d.writeln('');
   d.writeln('         alert("Enter your Total Points Prediction for \\"" + winning_team + " over " + losing_team + "\\" (Game '+number_of_rs_games+').");');
   d.writeln('      }');
   d.writeln('');
   d.writeln('      return false;');
   d.writeln('   }');
...
function build_post_season_form()
{
   ...
   d.writeln('            {');
   d.writeln('               // The spread_value is invalid, so randomly generate it.');
   d.writeln('');
   d.writeln('               spread_values[i] = Math.floor(Math.random() * ('+random_picks_max_spread+') + 1);');
   d.writeln('            }');
   d.writeln('            else');
