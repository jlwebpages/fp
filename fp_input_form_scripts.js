...
function build_regular_season_form()
{
   ...
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"text-align: left; padding-top: 5px; padding-bottom: 10px\\" colspan=5><b>Name:&nbsp&nbsp" + build_player_name(-1) + "</b></td></tr>";');
   d.writeln('   confirmation_message += format_picks_for_dialog(document,true,0);');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"text-align: left; padding-top: 10px; padding-bottom: 5px\\" colspan=5>Monday Night Total Points:&nbsp&nbsp" + document.fp_inputs.mn_points.value + "</td></tr>";');
   d.writeln('   confirmation_message += "\\n<tr><td colspan=5><hr style=\\"border: 1px solid black\\"></td></tr>";');
   d.writeln('   confirmation_message += "\\n</table>";');
   d.writeln('   confirmation_message += "\\n</center>\\n";');
   d.writeln('');
...
function build_post_season_form()
{
   ...
   d.writeln('');
   d.writeln('      confirmation_message += "\\n<tr" + upset_color_class + " style=\\"line-height: 100%\\">";');
   d.writeln('      confirmation_message += "<td style=\\"text-align: left; padding: 0px 30px 0px 0px\\">" + winning_team + "</td>";');
   d.writeln('      confirmation_message += "<td style=\\"padding: 0px\\">over</td>";');
   d.writeln('      confirmation_message += "<td style=\\"text-align: left; padding: 0px 30px 0px 30px\\">" + losing_team + "</td>";');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   confirmation_message += "\\n<tr><td style=\\"text-align: left; padding-top: 10px; padding-bottom: 5px\\" colspan=5>\\n\\"" + total_points_game + "\\" Total Points:&nbsp&nbsp" + total_points + "</td></tr>";');
   d.writeln('   confirmation_message += "\\n<tr><td colspan=5><hr style=\\"border: 1px solid black\\"></td></tr>";');
   d.writeln('   confirmation_message += "\\n</table>";');
   d.writeln('   confirmation_message += "\\n</center>\\n";');
   d.writeln('');
