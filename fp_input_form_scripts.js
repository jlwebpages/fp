...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('      // If current game pointer doesn\'t contain point spreads, then skip over it.');
   d.writeln('');
   d.writeln('      if ( (game.displayGroups[0].markets[0] == undefined) && (game.displayGroups[0].markets[1] == undefined) ) continue;');
   d.writeln('');
   ...
   d.writeln('         {');
   d.writeln('            markets_index = 0;');
   d.writeln('');
   d.writeln('            if ( (game.displayGroups[0].markets[markets_index].outcomes[0]                == undefined) ||  ');
   d.writeln('                 (game.displayGroups[0].markets[markets_index].outcomes[0].price.handicap == undefined)    )');
   d.writeln('            {');
   d.writeln('               markets_index = 1;');
   d.writeln('            }');
   d.writeln('');
   ...
   d.writeln('            {');
   d.writeln('               if (game.displayGroups[0].markets[markets_index].outcomes[k] != undefined)');
   d.writeln('               {');
   d.writeln('                  if (game.displayGroups[0].markets[markets_index].outcomes[k].price.handicap < 0)');
   d.writeln('                  {');
   d.writeln('                     favored_team = game.displayGroups[0].markets[markets_index].outcomes[k].description;');
   d.writeln('                     point_spread = game.displayGroups[0].markets[markets_index].outcomes[k].price.handicap;');
   d.writeln('                     odds_found   = true;');
   d.writeln('                  }');
   d.writeln('                  else if (game.displayGroups[0].markets[markets_index].outcomes[k].price.handicap > 0)');
   d.writeln('                  {');
   d.writeln('                     if (game.displayGroups[0].markets[markets_index].outcomes[k].description.toLowerCase() == home_team.toLowerCase()) favored_team = visiting_team;');
   d.writeln('                     if (game.displayGroups[0].markets[markets_index].outcomes[k].description.toLowerCase() == visiting_team.toLowerCase()) favored_team = home_team;');
   d.writeln('                     point_spread = -1 * game.displayGroups[0].markets[markets_index].outcomes[k].price.handicap;');
   d.writeln('                     odds_found   = true;');
   d.writeln('                  }');
   d.writeln('                  else if (game.displayGroups[0].markets[markets_index].outcomes[k].price.handicap == 0)  // The odds are assumed to be even for this game.');
   d.writeln('                  {');
   ...
   d.writeln('            }');
   d.writeln('');
   d.writeln('            // If a favored team and point spread are not found then skip to the next game in the loop.');
   d.writeln('');
   d.writeln('            if (odds_found == false) continue;');
   d.writeln('');
   d.writeln('            // Get the total points from the game information.');
   d.writeln('');
   d.writeln('            if ( (game.displayGroups[0].markets[markets_index+1] != undefined) && (game.displayGroups[0].markets[markets_index+1].outcomes[0] != undefined) )');
   d.writeln('            {');
   d.writeln('               total_points = game.displayGroups[0].markets[markets_index+1].outcomes[0].price.handicap;');
   d.writeln('            }');
   d.writeln('            else if ( (game.displayGroups[0].markets[markets_index+1] != undefined) && (game.displayGroups[0].markets[markets_index+1].outcomes[1] != undefined) )');
   d.writeln('            {');
   d.writeln('               total_points = game.displayGroups[0].markets[markets_index+1].outcomes[1].price.handicap;');
   d.writeln('            }');
   d.writeln('            else');
   d.writeln('            {');
   ...
   d.writeln('            nfl_odds_array[noa_index] = nfl_odds_array[noa_index].split(" ");');
   d.writeln('');
