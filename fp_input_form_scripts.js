...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('               if ( (get_point_spreads_string(losing_team,true) != "") && (display_spreads_from_odds == true || picks_already_validated == true) )');
   d.writeln('               {');
   d.writeln('                  // Change the text color for this game to indicate this game is an upset pick.');
   d.writeln('');
   d.writeln('                  upset_color = upset_style;');
   d.writeln('               }');
   d.writeln('            }');
   d.writeln('');
   ...
   d.writeln('         weight = "";');
   d.writeln('');
   d.writeln('         winning_team = visiting_teams[j] + get_point_spreads_string(visiting_teams[j],false);');
   d.writeln('         losing_team  = home_teams[j]     + get_point_spreads_string(home_teams[j],false);');
   d.writeln('')
   d.writeln('         // Build the line in HTML Table Record (<tr>) format.');
   d.writeln('');
   ...
   d.writeln('   {');
   d.writeln('      alert("You must select your name before home team picks can be generated.");');
   d.writeln('');
   d.writeln('      return false;');
   d.writeln('   }');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('               document.fp_inputs.mn_points.value = home_team_picks_array[i][noa_total_points_index];');
   d.writeln('            }');
   d.writeln('');
   d.writeln('            break;');
   d.writeln('         }');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // If Monday Night Total Points don\'t exist, then randomly generate Monday Night Total Points.');
   d.writeln('');
   ...
   d.writeln('   var nfl_odds_url   = "www.espn.com/nfl/lines";');
   d.writeln('');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('   for (var i = 0; i < Object.getOwnPropertyNames(nfl_odds.lines).length; i++)');
   d.writeln('   {');
   d.writeln('      game_list = nfl_odds.lines[Object.getOwnPropertyNames(nfl_odds.lines)[i]].lines;');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('         // Get the home and visiting teams (visiting team is assumed to be in row[0] and home team is assumed to be in row[1]).');
   d.writeln('');
   d.writeln('         visiting_team = game.rows[0].team.displayName;');
   d.writeln('         home_team = game.rows[1].team.displayName;');
   d.writeln('');
   d.writeln('         // If home_team or visiting_team is "Washington", set to "Washington Football Team".');
   d.writeln('');
   d.writeln('         if (home_team     == "Washington") home_team     = "Washington Football Team";');
   d.writeln('         if (visiting_team == "Washington") visiting_team = "Washington Football Team";');
   d.writeln('');
   d.writeln('         // Loop through each game in the selcted week.');
   d.writeln('');
   d.writeln('         for (var k = 0; k < '+number_of_rs_games+'; k++)');
   d.writeln('         {');
   d.writeln('            // If the home and visiting teams from the current game match one of the games');
   d.writeln('            // in the selected week, then get the NFL Odds information from the current game.');
   d.writeln('');
   ...
   d.writeln('            {');
   d.writeln('               // Get the favored team, point spread, and total_points from the current game.');
   d.writeln('');
   d.writeln('               odds_found = false;');
   d.writeln('');
   d.writeln('               for (var l = 1; l <= 2; l++)');
   d.writeln('               {');
   d.writeln('                  for (var m = 0; m <= 1; m++)');
   d.writeln('                  {');
   d.writeln('                     if (isNaN(game.rows[m].stats[l]) == false)');
   d.writeln('                     {');
   d.writeln('                        if (game.rows[m].stats[l] <= 0)');
   d.writeln('                        {');
   d.writeln('                           // Get the point spread.');
   d.writeln('');
   d.writeln('                           point_spread = game.rows[m].stats[l];');
   d.writeln('');
   d.writeln('                           if (point_spread % 1 == 0) point_spread = Math.floor(point_spread);');
   d.writeln('');
   d.writeln('                           // Get the favored team.');
   d.writeln('');
   d.writeln('                           if (m == 0) favored_team = visiting_team;');
   d.writeln('                           if (m == 1) favored_team = home_team;');
   d.writeln('');
   d.writeln('                           if (point_spread == 0) favored_team = home_team;');
   d.writeln('');
   d.writeln('                           // Set the odds_found flag.');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('                           total_points = game.rows[m].stats[l];');
   d.writeln('');
   d.writeln('                           // If total points is a whole number, change its format from floating point to whole number.');
   d.writeln('');
   ...
   d.writeln('                  }');
   d.writeln('');
   d.writeln('                  if (odds_found == true) break;');
   d.writeln('               }');
   d.writeln('            }');
   d.writeln('            else');
   d.writeln('            {');
   d.writeln('               // Home and visiting teams don\'t match so skip to the next game in the selected week.');
   d.writeln('');
   d.writeln('               continue;');
   d.writeln('            }');
   d.writeln('');
   d.writeln('            // Remove the city name from the favored team.');
   d.writeln('');
   d.writeln('            for (var l = 0; l < '+number_of_rs_games+'; l++)');
   d.writeln('            {');
   d.writeln('               if (favored_team.toLowerCase().indexOf(home_teams[l].toLowerCase()) != -1)');
   d.writeln('               {');
   d.writeln('                  favored_team = home_teams[l]');
   d.writeln('');
   d.writeln('                  break;');
   d.writeln('               }');
   d.writeln('               else if (favored_team.toLowerCase().indexOf(visiting_teams[l].toLowerCase()) != -1)');
   d.writeln('               {');
   d.writeln('                  favored_team = visiting_teams[l]');
   d.writeln('');
   d.writeln('                  break;');
   d.writeln('               }');
   d.writeln('            }');
...
function build_post_season_form()
{
   ...
   d.writeln('   if (picks_from_odds_button_pressed == true) picks_from_odds = true;');
   d.writeln('');
   d.writeln('   // Reset the picks_from_odds_button_pressed and random_picks_button_pressed flags.');
   d.writeln('');
   d.writeln('   picks_from_odds_button_pressed = false;');
   d.writeln('   random_picks_button_pressed    = false;');
   d.writeln('');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // Reset the random_picks_button_pressed flag and set the picks_from_odds_button_pressed flag.');
   d.writeln('');
   d.writeln('   picks_from_odds_button_pressed = true;');
   d.writeln('   random_picks_button_pressed    = false;');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('               document.fp_inputs.points.value = nfl_odds_array[i][noa_total_points_index];');
   d.writeln('            }');
   d.writeln('');
   d.writeln('            break;');
   d.writeln('         }');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // Reset the picks_from_odds_button_pressed flag and set the random_picks_button_pressed flag.');
   d.writeln('');
   d.writeln('   picks_from_odds_button_pressed = false;');
   d.writeln('   random_picks_button_pressed    = true;');
   d.writeln('');
   ...
   d.writeln('   var nfl_connection = null;');
   d.writeln('   var nfl_odds       = null;');
   d.writeln('   var nfl_odds_url   = "www.bovada.lv/services/sports/event/v2/events/A/description/football/nfl";');
   d.writeln('');
   d.writeln('');
   d.writeln('   // Always display alerts if name contains "JL".');
   d.writeln('');
   ...
   d.writeln('   var game_list     = "";');
   d.writeln('   var home_team     = "";');
   d.writeln('   var index_ps      = -1;');
   d.writeln('   var index_tp      = -1;');
   d.writeln('   var odds_found    = false;');
   d.writeln('   var point_spread  = 0;');
   d.writeln('   var total_points  = 0;');
   d.writeln('   var visiting_team = "";');
   ...
   d.writeln('   if (build_player_name(-1).indexOf("JL") != -1) suppress_alerts = false;');
   d.writeln('');
   d.writeln('   // Convert nfl_odds string to a JavaScript object.');
   d.writeln('');
   d.writeln('   nfl_odds = JSON.parse(nfl_odds);');
   d.writeln('');
   d.writeln('   // Get the game list from nfl_odds.');
   d.writeln('');
   d.writeln('   game_list = nfl_odds[0].events;');
   d.writeln('');
   d.writeln('   // Loop through each game in the game list.');
   d.writeln('');
   d.writeln('   for (var i = 0; i < game_list.length; i++)');
   d.writeln('   {');
   d.writeln('      // Get the current game pointer from the game list.');
   d.writeln('');
   d.writeln('      game = game_list[i];');
   d.writeln('');
   d.writeln('      // If the current game pointer doesn\'t represent a game event, then skip over it.');
   d.writeln('');
   d.writeln('      if (game.type.toLowerCase() != "gameevent") continue;');
   d.writeln('');
   d.writeln('      // If the current game doesn\'t contain a competitors array with two elements, then skip over it.');
   d.writeln('');
   d.writeln('      if ( (game.competitors == undefined) || (game.competitors.length != 2) ) continue;');
   d.writeln('');
   d.writeln('      // If the current game doesn\'t contain a displayGroups array with at least one element, then skip over it.');
   d.writeln('');
   d.writeln('      if ( (game.displayGroups == undefined) || (game.displayGroups.length < 1) ) continue;');
   d.writeln('');
   d.writeln('      // If the current game displayGroups array doesn\'t contain a markets array with at least one element, then skip over it.');
   d.writeln('');
   d.writeln('      if ( (game.displayGroups[0].markets == undefined) || (game.displayGroups[0].markets.length < 1) ) continue;');
   d.writeln('');
   d.writeln('      // Determine which markets array element contains the point spread.');
   d.writeln('');
   d.writeln('      index_ps = -1;');
   d.writeln('');
   d.writeln('      for (var j = 0; j < game.displayGroups[0].markets.length; j++)');
   d.writeln('      {');
   d.writeln('         if ( (game.displayGroups[0].markets[j].description.toLowerCase() == "point spread") &&');
   d.writeln('              (game.displayGroups[0].markets[j].period.description.toLowerCase() == "match") )');
   d.writeln('         {');
   d.writeln('            index_ps = j;');
   d.writeln('            break;');
   d.writeln('         }');;
   d.writeln('      }');
   d.writeln('');
   d.writeln('      // Determine which markets array element contains the total points.');
   d.writeln('');
   d.writeln('      index_tp = -1;');
   d.writeln('');
   d.writeln('      for (var j = 0; j < game.displayGroups[0].markets.length; j++)');
   d.writeln('      {');
   d.writeln('         if ( (game.displayGroups[0].markets[j].description.toLowerCase() == "total") &&');
   d.writeln('              (game.displayGroups[0].markets[j].period.description.toLowerCase() == "match") )');
   d.writeln('         {');
   d.writeln('            index_tp = j;');
   d.writeln('            break;');
   d.writeln('         }');;
   d.writeln('      }');
   d.writeln('');
   d.writeln('      // If the current game pointer doesn\'t contain a point spread, then skip over it.');
   d.writeln('');
   d.writeln('      if (index_ps == -1) continue;');
   d.writeln('');
   ...
   d.writeln('      if (game.competitors[1].home == true) home_team = game.competitors[1].name;');
   d.writeln('');
   d.writeln('      if (game.competitors[0].home == false) visiting_team = game.competitors[0].name;');
   d.writeln('      if (game.competitors[1].home == false) visiting_team = game.competitors[1].name;');
   d.writeln('');
   d.writeln('      // Loop through this week\'s games.');
   d.writeln('');
   d.writeln('      for (var j = 0; j < '+number_of_ps_games+'; j++)');
   d.writeln('      {');
   d.writeln('         // If the home and visiting teams from the game information match one of this');
   d.writeln('         // week\'s games, then get the Odds information from the game information.');
   d.writeln('');
   ...
   d.writeln('         {');
   d.writeln('            // Get the favored team and point spread from the game information.');
   d.writeln('');
   d.writeln('            for (var k = 0; k < 2; k++)');
   d.writeln('            {');
   d.writeln('               if (game.displayGroups[0].markets[index_ps].outcomes[k] != undefined)');
   d.writeln('               {');
   d.writeln('                  if (game.displayGroups[0].markets[index_ps].outcomes[k].price.handicap < 0)');
   d.writeln('                  {');
   d.writeln('                     favored_team = game.displayGroups[0].markets[index_ps].outcomes[k].description;');
   d.writeln('                     point_spread = game.displayGroups[0].markets[index_ps].outcomes[k].price.handicap;');
   d.writeln('                     odds_found   = true;');
   d.writeln('                  }');
   d.writeln('                  else if (game.displayGroups[0].markets[index_ps].outcomes[k].price.handicap > 0)');
   d.writeln('                  {');
   d.writeln('                     if (game.displayGroups[0].markets[index_ps].outcomes[k].description.toLowerCase() == home_team.toLowerCase()) favored_team = visiting_team;');
   d.writeln('                     if (game.displayGroups[0].markets[index_ps].outcomes[k].description.toLowerCase() == visiting_team.toLowerCase()) favored_team = home_team;');
   d.writeln('                     point_spread = -1 * game.displayGroups[0].markets[index_ps].outcomes[k].price.handicap;');
   d.writeln('                     odds_found   = true;');
   d.writeln('                  }');
   d.writeln('                  else if (game.displayGroups[0].markets[index_ps].outcomes[k].price.handicap == 0)  // The odds are assumed to be even for this game.');
   d.writeln('                  {');
   ...
   d.writeln('            }');
   d.writeln('');
   d.writeln('            // If a favored team and point spread are not found then skip over this game.');
   d.writeln('');
   d.writeln('            if (odds_found == false) continue;');
   d.writeln('');
   d.writeln('            // Get the total points from the game information.');
   d.writeln('');
   d.writeln('            if (index_tp != -1)');
   d.writeln('            {');
   d.writeln('               if (game.displayGroups[0].markets[index_tp].outcomes[0] != undefined)');
   d.writeln('               {');
   d.writeln('                  total_points = game.displayGroups[0].markets[index_tp].outcomes[0].price.handicap;');
   d.writeln('               }');
   d.writeln('               else if (game.displayGroups[0].markets[index_tp].outcomes[1] != undefined)');
   d.writeln('               {');
   d.writeln('                  total_points = game.displayGroups[0].markets[index_tp].outcomes[1].price.handicap;');
   d.writeln('               }');
   d.writeln('            }');
   d.writeln('');
   d.writeln('            // If total points is a whole number, change its format from floating point to whole number.');
   ...
   d.writeln('            nfl_odds_array[j] = "1 2 3".split(" ");');
   d.writeln('');
   d.writeln('            // Put the Odds information into the nfl_odds_array[j] array.');
   d.writeln('');
   d.writeln('            nfl_odds_array[j][noa_team_index]         = favored_team;');
   d.writeln('            nfl_odds_array[j][noa_spread_index]       = point_spread;');
   d.writeln('            nfl_odds_array[j][noa_total_points_index] = total_points;');
   d.writeln('');
   d.writeln('            //JL alert(nfl_odds_array[j]);');
   d.writeln('');
   d.writeln('            break;');
   d.writeln('         }');
   d.writeln('      }');
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // If an nfl_odds_array element is blank because one of this week\'s games wasn\'t found in the game_list, then initialize the nfl_odds_array element.');
   d.writeln('');
   d.writeln('   for (var j = 0; j < '+number_of_ps_games+'; j++)');
   d.writeln('   {');
   d.writeln('      if (nfl_odds_array[j] == "")');
