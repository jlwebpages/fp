...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('');
   d.writeln('function format_picks_for_dialog(document,picks_validated,game_to_format)');
   d.writeln('{');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   if (picks_validated == true)');
   d.writeln('   {');
   ...
   d.writeln('            }');
   d.writeln('');
   d.writeln('            if ((picks_validated == true) && (nfl_odds_array[0].length > 0))');
   d.writeln('            {');
   ...
   d.writeln('');
   d.writeln('                        winning_team = winning_team + " " + nfl_odds_array[k][noa_spread_index];');
   d.writeln('                     }');
   d.writeln('');
   d.writeln('                     break;');
   d.writeln('                  }');
   d.writeln('                  else if (losing_team == nfl_odds_array[k][noa_team_index])');
   d.writeln('                  {');
   d.writeln('                     if (display_spreads_from_odds == true)');
   d.writeln('                     {');
   d.writeln('                        // Add the NFL Odds point spread to the losing team.');
   d.writeln('');
   d.writeln('                        losing_team = losing_team + " " + nfl_odds_array[k][noa_spread_index];');
   d.writeln('                     }');
   d.writeln('');
   d.writeln('                     if (nfl_odds_array[k][noa_spread_index] != "")');
   d.writeln('                     {');
   ...
   d.writeln('            }');
   d.writeln('');
   d.writeln('            winning_team = pad_text_string(winning_team,picks_validated);');
   d.writeln('            losing_team = pad_text_string(losing_team,picks_validated);');
   d.writeln('');
   d.writeln('            // Finish building the rest of the line for this game.');
   d.writeln('');
   d.writeln('            if (picks_validated == false)');
   d.writeln('            {');
   ...
   d.writeln('            }');
   d.writeln('');
   d.writeln('            formatted_picks = formatted_picks + html_tag_start + game_prefix + winning_team;');
   d.writeln('');
   ...
   d.writeln('            }');
   d.writeln('');
   d.writeln('            formatted_picks = formatted_picks + pick + " " + weight + html_tag_end + "\\n";');
   d.writeln('');
   ...
   d.writeln('         if (picks[j] == "H")');
   d.writeln('         {');
   d.writeln('            winning_team = pad_text_string(home_teams[j],picks_validated);');
   d.writeln('            losing_team  = pad_text_string(visiting_teams[j],picks_validated);');
   d.writeln('         }');
   d.writeln('         else');
   d.writeln('         {');
   d.writeln('            winning_team = pad_text_string(visiting_teams[j],picks_validated);');
   d.writeln('            losing_team  = pad_text_string(home_teams[j],picks_validated);');
   d.writeln('         }');
   d.writeln('');
   d.writeln('         if (picks_validated == false)');
   d.writeln('         {');
   ...
   d.writeln('');
   d.writeln('');
   d.writeln('function pad_text_string(input_string,picks_validated)');
   d.writeln('{');
   ...
   d.writeln('<tr><td class="no_border" style="font-size: 1pt">&nbsp;</td></tr>');
   d.writeln('');
