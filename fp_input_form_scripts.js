...
function build_regular_season_form()
{
   ...
   home_team_picks_tooltip += "     - Pick all home teams and assign weights and total points based on the NFL Odds.&#10;";
   ...
   d.writeln('{');
   d.writeln('   var end_index             = 0;');  
   d.writeln('   var home_team_picks_array = new Array('+number_of_rs_games+');');
   d.writeln('   var point_spread          = "";');
   d.writeln('   var start_index           = 0;');  
   d.writeln('   var start_position        = 0;');   
   d.writeln('   var temp_array            = [];');
   d.writeln('   var temp_array_index      = 0;');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // Set the home_team_picks_button_pressed flag.');
   d.writeln('');
   ...
   d.writeln('')
   d.writeln('   // Force teams with the same point spread to be ordered randomly within the list.');
   d.writeln('');
   d.writeln('   for (var i = 0; i < home_team_picks_array.length; i++)');
   d.writeln('   {');
   d.writeln('      temp_array = [];');
   d.writeln('');
   d.writeln('      if (i == 0)');
   d.writeln('      {');
   d.writeln('         point_spread = home_team_picks_array[i][noa_spread_index];');
   d.writeln('');
   d.writeln('         continue;');
   d.writeln('      }');
   d.writeln('');
   d.writeln('      if (home_team_picks_array[i][noa_spread_index] != point_spread)');
   d.writeln('      {');
   d.writeln('         // Capture the teams with the same point spread.');
   d.writeln('');
   d.writeln('         temp_array  = home_team_picks_array.slice(start_position,i);');
   d.writeln('         start_index = start_position;');
   d.writeln('         end_index   = i-1;');
   d.writeln('');
   d.writeln('         // Set variables for next loop interation.');
   d.writeln('');
   d.writeln('         point_spread   = home_team_picks_array[i][noa_spread_index];');
   d.writeln('         start_position = i;');
   d.writeln('      }');
   d.writeln('      else if (i == home_team_picks_array.length - 1)');
   d.writeln('      {');
   d.writeln('         // Capture the teams with the same point spread.');
   d.writeln('');
   d.writeln('         temp_array  = home_team_picks_array.slice(start_position,i+1);');
   d.writeln('         start_index = start_position;');
   d.writeln('         end_index   = i;');
   d.writeln('      }');
   d.writeln('');
   d.writeln('      if (temp_array.length > 1)');
   d.writeln('      {');
   d.writeln('         // Ordered the teams with the same point spread randomly within the list.');
   d.writeln('');
   d.writeln('         temp_array.sort(() => Math.random() - 0.5);');
   d.writeln('         temp_array_index = 0;');
   d.writeln('');
   d.writeln('         for (var j = start_index; j <= end_index; j++)');
   d.writeln('         {');
   d.writeln('            home_team_picks_array[j] = temp_array[temp_array_index];');
   d.writeln('            temp_array_index++;');
   d.writeln('         }');
   d.writeln('      }');
   d.writeln('   }');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('            nfl_odds_array[noa_index] = "1 2 3 4".split(" ");');
   d.writeln('');
   d.writeln('            // Put the Odds information into the nfl_odds_array[noa_index] four element array.');
   d.writeln('');
