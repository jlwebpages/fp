...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('      if (game.displayGroups[0].markets[0] == undefined) continue;');
   d.writeln('');
   ...
   d.writeln('            {');
   d.writeln('               if (game.displayGroups[0].markets[0].outcomes[k] != undefined)');
   d.writeln('               {');
   d.writeln('                  if (game.displayGroups[0].markets[0].outcomes[k].price.handicap < 0)');
   d.writeln('                  {');
   d.writeln('                     favored_team = game.displayGroups[0].markets[0].outcomes[k].description;');
   d.writeln('                     point_spread = game.displayGroups[0].markets[0].outcomes[k].price.handicap;');
   d.writeln('                     odds_found   = true;');
   d.writeln('                  }');
   d.writeln('                  else if (game.displayGroups[0].markets[0].outcomes[k].price.handicap > 0)');
   d.writeln('                  {');
   d.writeln('                     if (game.displayGroups[0].markets[0].outcomes[k].description.toLowerCase() == home_team.toLowerCase()) favored_team = visiting_team;');
   d.writeln('                     if (game.displayGroups[0].markets[0].outcomes[k].description.toLowerCase() == visiting_team.toLowerCase()) favored_team = home_team;');
   d.writeln('                     point_spread = -1 * game.displayGroups[0].markets[0].outcomes[k].price.handicap;');
   d.writeln('                     odds_found   = true;');
   d.writeln('                  }');
   d.writeln('                  else if (game.displayGroups[0].markets[0].outcomes[k].price.handicap == 0)  // The odds are assumed to be even for this game.');
   d.writeln('                  {');
   ...
   d.writeln('');
   d.writeln('            if ( (game.displayGroups[0].markets[1] != undefined) && (game.displayGroups[0].markets[1].outcomes[0] != undefined) )');
   d.writeln('            {');
   d.writeln('               total_points = game.displayGroups[0].markets[1].outcomes[0].price.handicap;');
   d.writeln('            }');
   d.writeln('            else if ( (game.displayGroups[0].markets[1] != undefined) && (game.displayGroups[0].markets[1].outcomes[1] != undefined) )');
   d.writeln('            {');
