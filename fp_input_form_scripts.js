...
function build_regular_season_form()
{
   ...
   d.writeln('   for (var i = 0; i < '+number_of_nfl_teams+'; i++)');
   d.writeln('   {');
   d.writeln('      team_records_array[i] = "<team_name> <team_record>".split(" ");');
   d.writeln('   }');
   d.writeln('}');
   d.writeln('');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('         // Get the home and visiting team names and records (visiting is assumed to be in row[0] and home is assumed to be in row[1]).');
   d.writeln('');
   d.writeln('         visiting_team        = game.rows[0].team.displayName;');
   d.writeln('         visiting_team_record = game.rows[0].stats[0];');
   d.writeln('         home_team            = game.rows[1].team.displayName;');
   d.writeln('         home_team_record     = game.rows[1].stats[0];');
   d.writeln('');
...
function build_post_season_form()
{
   ...
   d.writeln('            // Remove the city name from the favored team.');
   d.writeln('');
   d.writeln('            for (var l = 0; l < '+number_of_ps_games+'; l++)');
   d.writeln('            {');
   d.writeln('               if (favored_team.toLowerCase().indexOf(home_teams[l].toLowerCase()) != -1)');
   d.writeln('               {');
   d.writeln('                  favored_team = home_teams[l]');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // If an nfl_odds_array element is blank because one of this week\'s games wasn\'t found in any of the game_lists, initialize the nfl_odds_array element.');
   d.writeln('');
   d.writeln('   for (var j = 0; j < '+number_of_ps_games+'; j++)');
   d.writeln('   {');
   d.writeln('      if (nfl_odds_array[j] == "")');
   ...
   d.writeln('   for (var i = 0; i < '+number_of_ps_games+'; i++)');
   d.writeln('   {');
   d.writeln('      document.getElementById(home_teams[i]).innerHTML     = home_teams[i]     + get_point_spread_string(home_teams[i],false);');
   d.writeln('      document.getElementById(visiting_teams[i]).innerHTML = visiting_teams[i] + get_point_spread_string(visiting_teams[i],false);');
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // Call to display_frame will set the mobile viewport width.');
   d.writeln('');
