...
function build_regular_season_form()
{
   ...
   d.writeln('   {');
   d.writeln('      wd.writeln("<input type=\\"button\\" style=\\"font-size: 11pt; font-family: Calibri; border: 1px solid black; color: black\\" value=\\""+button_3+"\\" onClick=respond_to_button(\\"fix_1\\");>");');
   d.writeln('      wd.writeln("&nbsp&nbsp");');
   d.writeln('      wd.writeln("<input type=\\"button\\" style=\\"font-size: 11pt; font-family: Calibri; border: 1px solid black; color: black\\" value=\\""+button_2+"\\" onClick=respond_to_button(\\"fix_2\\");>");');
   d.writeln('      wd.writeln("&nbsp&nbsp");');
   d.writeln('   }');
