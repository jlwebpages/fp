...
function build_regular_season_form()
{
   ...
   d.writeln('                  upset_note        = "<b>Note:</b>&nbsp&nbsp<font" + upset_color_class + ">These games are upset picks.</font>";');
   d.writeln('               }');
   d.writeln('            }');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('      // Loop through the selected week\'s games.');
   d.writeln('');
   d.writeln('      for (var j = 0; j < '+number_of_rs_games+'; j++)');
   d.writeln('      {');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // If an nfl_odds_array element is blank because a game in the selected week wasn\'t found the game_list, then initialize the nfl_odds_array element.');
   d.writeln('');
   d.writeln('   for (var j = 0; j < '+number_of_rs_games+'; j++)');
   d.writeln('   {');
