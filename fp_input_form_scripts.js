...
function build_regular_season_form()
{
   ...
   d.writeln('   var saved_display_frame_name = "";');
   ...
   d.writeln('');
   d.writeln('            // Remove loading indicator by restoring the previous display frame.');
   d.writeln('');
   d.writeln('            top.display_frame(saved_display_frame_name);');
   d.writeln('');
   d.writeln('            return false;');
   d.writeln('         }');
   d.writeln('      }');
