...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('');
   d.writeln('// Define variables for functions related to NFL Odds.');
   d.writeln('');
   d.writeln('var display_spreads                = true;  // This is a configuration flag only set here and only read elsewhere.');
   ...
   d.writeln('');
   d.writeln('                     if ((picks_from_odds_button_pressed == true) || (display_spreads == true))');
   d.writeln('                     {');
   d.writeln('                        // Add the spread to the winning team.');
   d.writeln('');
   ...
   d.writeln('                     if ((picks_from_odds_button_pressed == true) || (display_spreads == true))');
   d.writeln('                     {');
   d.writeln('                        // Add the spread to the losing team.');
   d.writeln('');
   ...
   d.writeln('      }');
   d.writeln('');
   d.writeln('      // Put the point spread in the second element in nfl_odds_array.');
   d.writeln('');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // Convert each element of the nfl_odds_array into an array');
   d.writeln('   // itself and make sure that the spread value is of type float.');
   d.writeln('');
   d.writeln('   for (var i = 0; i < '+number_of_games+'; i++)');
   d.writeln('   {');
   ...
   d.writeln('');
   d.writeln('   if ((picks_from_odds_button_pressed == true || display_spreads == true) && (nfl_odds_array[0].length > 0))');
   d.writeln('   {');
