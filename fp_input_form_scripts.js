...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('      home_team_picks_array[i] = "1 2 3 4".split(" ");');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('   home_team_picks_array.sort');
   ...
   d.writeln('   {');
   d.writeln('      prompt_message = "\\"Home Team Picks\\" needs Monday Night Total Points for \\""+visiting_teams['+number_of_rs_games+'-1]+" at "+home_teams['+number_of_rs_games+'-1]+".\\"  Enter a number between 1 and 99.\\n\\n";');
   d.writeln('');
   ...
   d.writeln('      clear_picks_from_input_form();');
   d.writeln('');
   d.writeln('      // Clear the home_team_picks_button_pressed flag.');
   d.writeln('');
