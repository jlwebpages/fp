...
function build_regular_season_form()
{
   ...
   d.writeln('   wd.writeln("");');
   d.writeln('   wd.writeln("      // Clear out NFL Odds array.");');
   d.writeln('   wd.writeln("");');
   d.writeln('   wd.writeln("      top.fp_main.clear_nfl_odds_array();");');
   d.writeln('   wd.writeln("   }");');
   d.writeln('   wd.writeln("");');
   ...
   d.writeln('');
   d.writeln('');
   d.writeln('function format_picks_for_dialog(document,confirm_picks,requested_game)');
   d.writeln('{');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   if ((confirm_picks == true) && (picks_from_odds_button_pressed == false))');
   d.writeln('   {');
   ...
   d.writeln('                  {');
   d.writeln('                     // The team picked to win is favored so don\'t change the text color for this game.');
   d.writeln('');
   ...
   d.writeln('                     // However, don\'t change the color if the point spread is blank because that means the odds for this game are even.');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('            if (confirm_picks == false)');
   d.writeln('            {');
...
function build_post_season_form()
{
   ...
   d.writeln('');
   d.writeln('');
   d.writeln('   if (picks_from_odds_button_pressed == false)');
   d.writeln('   {');
   d.writeln('      // Get the NFL Odds so we can determine which games are upset picks.');
   d.writeln('');
   d.writeln('      get_nfl_odds(document,true);');
