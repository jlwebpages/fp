...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('               for (var l = 0; l <= 1; l++)');
   d.writeln('               {');
   d.writeln('                  if (isNaN(game.rows[l].stats[1]) == false)');
   d.writeln('                  {');
   d.writeln('                     if (game.rows[l].stats[1] <= 0)');
   d.writeln('                     {');
   d.writeln('                        // Get the point spread.');
   d.writeln('');
   d.writeln('                        point_spread = game.rows[l].stats[1];');
   d.writeln('');
   d.writeln('                        if (point_spread % 1 == 0) point_spread = Math.floor(point_spread);');
   d.writeln('');
   d.writeln('                        // Get the favored team.');
   d.writeln('');
   d.writeln('                        if (l == 0) favored_team = visiting_team;');
   d.writeln('                        if (l == 1) favored_team = home_team;');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('                        total_points = game.rows[l].stats[1];');
   d.writeln('');
   ...
   d.writeln('            else');
   d.writeln('            {');
   d.writeln('               // Home and visiting teams don\'t match so skip the the next game in the selected week.');
   d.writeln('');
   d.writeln('               continue;');
   d.writeln('            }');
   d.writeln('');
