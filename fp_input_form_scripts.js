...
function build_regular_season_form()
{
   ...
   d.writeln('   index_end = nfl_odds.indexOf("},\\"totalPages\\"");');
   d.writeln('');
   d.writeln('   if ( (index_start == -1) || (index_end == -1) || (index_start > index_end) )');
   d.writeln('   {');
   ...
   d.writeln('');
   d.writeln('               visiting_team_record = game.rows[0].stats[0].displayValue;');
   d.writeln('               home_team_record     = game.rows[1].stats[0].displayValue;');
   d.writeln('');
   ...
   d.writeln('                  {');
   d.writeln('                     if (isNaN(game.rows[m].stats[l].displayValue) == false)');
   d.writeln('                     {');
   d.writeln('                        if (game.rows[m].stats[l].displayValue <= 0)');
   d.writeln('                        {');
   d.writeln('                           // Get the point spread.');
   d.writeln('');
   d.writeln('                           point_spread = game.rows[m].stats[l].displayValue;');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('                           // If point_spread is zero, then the odds are even.');
   d.writeln('');
   ...
   d.writeln('');
   d.writeln('                           total_points = game.rows[m].stats[l].displayValue;');
   d.writeln('');
   ...
   d.writeln('   }');
   d.writeln('');
   d.writeln('   // If an nfl_odds_array element is blank because one of this week\'s games wasn\'t found in');
   d.writeln('   // any of the game_lists or if the point_spread for any game is zero, set odds_found to false.');
   d.writeln('');
   d.writeln('   for (var j = 0; j < '+number_of_rs_games+'; j++)');
   d.writeln('   {');
   ...
   d.writeln('   var index_start           = -1;');
   d.writeln('   var odds_found            = false;');
   d.writeln('   var odds_index_consensus  = 0;');
   d.writeln('   var odds_index_caesars    = 1;');
   d.writeln('   var odds_index_draftkings = 2;');
   d.writeln('   var odds_index_fanduel    = 3;');
   d.writeln('   var odds_index_bet365     = 4;');
   d.writeln('   var odds_index            = odds_index_consensus;');
   d.writeln('   var point_spread          = 0;');
   d.writeln('   var team_records_index    = -1;');
   d.writeln('   var total_points          = 0;');
   d.writeln('   var visiting_team         = "";');
   ...
   d.writeln('');
   d.writeln('            odds_index = odds_index_consensus;');
   d.writeln('');
   d.writeln('            while (odds_index <= odds_index_bet365)');
   d.writeln('            {');
   ...
   for (var i = 1; i <= number_of_rs_games; i++)
   {
      ...
      if (i == number_of_rs_games)
      {
         ...
         d.writeln('<td nowrap class="gr1_border"><select style="font-size: 11pt; font-family: Calibri; border: 1px solid lightgray; background-color:white" name="pick'+i+'" size=1>');
      }
      else
      {
      ...
      if (i == number_of_rs_games)
      {
         d.writeln('<td nowrap class="no_border"><select style="font-size: 11pt; font-family: Calibri; border: 1px solid lightgray; background-color:white" name="weight'+i+'" size=1>');
      }
      else
      {
